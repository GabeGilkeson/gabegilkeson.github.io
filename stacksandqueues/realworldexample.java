...
public class realworldexample {
    public static void main(String[] args) {
        ...
        dmvLine.addNode(new StudentObject("Alice", "111 Main St", "1"));
        dmvLine.addNode(new StudentObject("Bob", "222 Elm St", "2"));
        dmvLine.addNode(new StudentObject("Charlie", "333 Oak St", "3"));

        //Serve people in the order they came
        while (!dmvLine.isEmpty()) {
            System.out.println("Now serving: " + dmvLine.removeFromFront());
        }
